...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    ...
    outline: 'border border-gray-300 bg-transparent text-gray-700 hover:bg-gray-50:bg-gray-800 focus:ring-primary-500',
    ghost: 'bg-transparent hover:bg-gray-100:bg-gray-800 text-gray-700 focus:ring-primary-500',
